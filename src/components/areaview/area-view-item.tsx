...
export class AreaViewItem extends React.Component<AreaViewItemProps, {}> {
  ...
  private itemTemplate(item: TodoItem) {
    if (this.props.isPrimary) {
      return (
        <div className="todo-item-content-extra">
          <span className="todo-item-content-source">{item.source}</span>
          {item.comments && (
      ...
      return (
        <div className="todo-item-content-extra">
          {item.inPrimaryList && (
            <span className="todo-item-content-source">我的一天</span>
          )}
          {item.comments && (
            <span className="todo-item-content-comments">备注</span>
          )}
  ...
  render() {
    ...
    return (
      <li
        ...
        <div
          className={
            item.done ? 'todo-item-content done' : 'todo-item-content'
          }>
          <span>{item.name}</span>
